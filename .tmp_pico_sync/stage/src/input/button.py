...
class AirBuddyButton:
    ...
    def __init__(
        ...
        # No dedicated button LED — fall back to the onboard user LED.
        # On XIAO ESP32-S3 this is GPIO21, active-low, so flip the polarity flag.
        if led_gpio is None:
            try:
                ...
                if _ulp is not None:
                    led_gpio = _ulp
                    led_active_high = (int(user_led_active_value()) == 1)
            except Exception:
                pass
